...
The system is ready for practical application in Smart City task scheduling and can be extended to support additional urban service planning scenarios.